 ...
 */
class TorrentDeletedDialog : DialogFragment() {
    ...
    companion object {
        ...
        fun newInstance(torrentName: String, torrentHash: String): TorrentDeletedDialog {
            val frag = TorrentDeletedDialog()
            val bundle = Bundle()
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val b = AlertDialog.Builder(activity)
                ...
                .setMessage(R.string.torrent_deleted_dialog_text)
